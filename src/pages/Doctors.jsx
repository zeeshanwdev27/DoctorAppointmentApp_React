...
function Doctors() {
  ...
  const { doctors }  = useContext(AppContext)     //bcz i store assets.js data in context
  ...
  return (
    <div>
      ...
      <div className='flex flex-col sm:flex-row items-start gap-10 mt-5'>
        ...
        <button onClick={()=> setShowFilter(prev => !prev)} className={`py-1 px-3 border border-primary text-primary font-semibold rounded text-sm transition-all sm:hidden ${showFilter ? 'bg-primary text-white': ''}`}>Show Filters</button>
